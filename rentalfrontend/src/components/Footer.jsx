    ...
    >
      <div className="flex items-center justify-around p-2 mobile:flex-col mobile:items-start">
        <div className="flex-1 flex flex-col flex-wrap p-2">
          ...
          <p>
            We are the only book rental store in Nepal and we promise to help
            our customers. We can keep in touch with following platforms.
          </p>
        ...
        <div className="flex-1 flex flex-col p-2">
          ...
          <div className="flex m-3">
            ...
            <p className="pl-3">+977-9841764056</p>
          </div>
          <div className="flex m-3">
            <EmailOutlined className="text-[#8a4af3]" />
            <p className="pl-3">rentabook3@gmail.com</p>
          </div>
        </div>
      </div>
    </motion.div>
