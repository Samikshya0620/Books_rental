    ...
    <div className="flex flex-col justify-center items-center">
      <div className="counter flex items-center text-xl justify-start">
        ...
        <div className="ml-5 shadow-md flex">
          <button onClick={()=> removeItem(item)} className="bg-teal-500 text-white w-8 flex items-center justify-center rounded-l-lg cursor-pointer">
            -
          </button>
          <div className="w-8 flex items-center justify-center border-[1px] border-[#8a4af3]">
            {item.quantity}
          </div>
          <button onClick={()=>addItem(item)} className="bg-teal-500 text-white w-8 flex items-center justify-center rounded-r-lg cursor-pointer">
            + </button> 
