...
const ProductPage = () => {
  ...
  return (
    <div>
      <Navbar />
      <div
        className={`grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-10 gap-8`}
      >
        {products.map((product, index) => (
          <motion.div
            key={product.id}
            className={`bg-white rounded-lg shadow-lg overflow-hidden ${
              isProductSelected ? "blur-sm" : ""
            }`}
        ...
        {selectedProduct && (
          ...
          >
            <div className="flex items-center justify-center min-h-screen">
              <div className="bg-[#e0fff3] rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 mt-2 flex justify-center font-bold">
